...
function success(pos) {
  ...
  for (const restaurant of restaurants) {
    ...
    const y1 = restaurant.location.coordinates[1];
    const x2 = crd.longitude;
    const y2 = crd.latitude;
    const dist = calculateDistance(x1, x2, y1, y2);
    restaurant.distance = dist;
  }
  restaurants.sort(sortByDistance);
  ...
  for (const restaurant of restaurants) {
    ...
    const distanceRow = document.createElement('td');
    distanceRow.innerText = restaurant.distance;
